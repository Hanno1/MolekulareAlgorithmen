...
class BracketEncoding(TriTree):
    """
    bracket encoding using the bracket alphabet. Passed down from tri tree
    """
    def __init__(self, root, initial_value=None, dna_value=None, branching_degree=3):
        """
        :param root: root node, can be none
        :param initial_value: initial value like in tri tree
        :param dna_value: dna value - encoded dna string has to be decoded into tree structure
        :param branching_degree: branching degree of the tree
        """
    ...
    def tree_to_dna(self):
        # returns tree encoded as dna string
